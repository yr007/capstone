...
def getConnection(): 
	...
	connenction_string = "dbname='cmucapstonejd' port='5439' user='cmucapstonejd' password='Ngl91dY2daIa3wFD1QhL' host='cmucapstone.cjvi8xu2ejaw.us-east-2.redshift.amazonaws.com'";
...
#    return Response('GET programs not implemented yet', status=status.HTTP_200_OK)
		...
		for key, value in request.GET.items():
			print(key, value)
			caseListCondition.append(value)
		...
		return Response('GET user', status=status.HTTP_200_OK)
